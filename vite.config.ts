        ...
        workbox: {
          ...
          runtimeCaching: [
            ...
            },
            {
              ...
              options: { cacheName: "edgelink-fonts", expiration: { maxEntries: 20, maxAgeSeconds: 60 * 60 * 24 * 365 } },
            },
          ],
        },
      }),
