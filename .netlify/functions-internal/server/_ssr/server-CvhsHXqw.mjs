...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CIH5Ny96.mjs");
...
var manifest = {
	"540c525aa0a7052979ba9bf807a4851175c4cdab6118647916867e035b22f02e": {
		functionName: "subscribeNewsletter_createServerFn_handler",
		importer: () => import("./inquiries.functions-B_nw2WKA.mjs")
	},
	"91320a5771b7bd16fea166384a6f51abe2a881df9a7d3131cad1b3f7d9e6a608": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-s5e8-avL.mjs").then((n) => n.t),
		import("./start-DzIgH0p4.mjs"),
...
//#endregion
export { getServerFnById as a, TSS_SERVER_FUNCTION as i, createMiddleware as n, createServerFn as r, server_exports as t };
