  ...
  head: () => ({
    meta: [
      { title: "FAQ — EDGELINK Tours" },
      {
        name: "description",
        content:
          "Answers to the most common questions about safaris, permits, visas, gorilla trekking, and travel in Rwanda.",
      },
      { property: "og:title", content: "FAQ — EDGELINK Tours" },
      {
        property: "og:description",
        content:
          "Answers to the most common questions about safaris, permits, visas, and gorilla trekking in Rwanda.",
      },
      ...
      <section className="border-b border-border bg-forest-deep py-16 text-primary-foreground md:py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <p className="mt-3 max-w-2xl text-primary-foreground/80">
            Answers from our head guides and operations team. Still curious? We reply within 24
            hours.
          </p>
        </div>
      </section>
