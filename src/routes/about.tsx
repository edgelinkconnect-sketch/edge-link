  ...
  head: () => ({
    meta: [
      { title: "About EDGELINK — Rwandan-owned Luxury Safaris" },
      {
        name: "description",
        content:
          "Founded by Rwandan guides. Twenty years of luxury expeditions, community ownership, and sustainable travel.",
      },
    ...
    <AppShell>
      <section className="border-b border-border bg-forest-deep py-16 text-primary-foreground md:py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <p className="mt-3 max-w-2xl text-primary-foreground/80">
            Connecting people, places and possibilities — EDGELINK Tours is our love letter to East
            Africa.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 md:px-6 md:py-24">
        ...
        >
          ...
          <h2 className="font-display text-3xl font-bold md:text-4xl">
            Founded by guides who grew up on these ridges.
          </h2>
          <div className="mt-6 space-y-4 text-lg leading-relaxed text-muted-foreground">
            <p>
              EDGELINK began in 2005 when a group of Volcanoes National Park guides realised the
              country's most iconic safaris were being sold by companies without a single Rwandan on
              staff. We started with one Land Cruiser, one gorilla permit at a time, and an
              unshakeable belief that Rwanda should be told by Rwandans.
            </p>
            <p>
              Twenty years later, we're Rwanda's leading independent luxury operator: 100% locally
              owned, RDB-certified, and trusted by discerning travellers from every continent. Our
              head guides average 15 years in the field. Our lodge partners are the best on the
              continent. Our clients become friends.
            </p>
          </div>
        </motion.div>
      </section>
            ...
            {TEAM.slice(0, 2).map((m, i) => (
              ...
              >
                <div className="relative shrink-0">
                  ...
                  <span className="absolute -bottom-1 -right-1 rounded-full bg-gold px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-gold-foreground">
                    Lead
                  </span>
                </div>
                <div>
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {TEAM.slice(2).map((m, i) => (
              ...
              >
                ...
                <div className="mt-1 text-[11px] font-semibold uppercase tracking-wider text-gold">
                  {m.role}
                </div>
      ...
      <section className="bg-forest-deep py-16 text-primary-foreground md:py-20">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
          ...
          <h2 className="font-display text-3xl font-bold md:text-4xl">
            Sustainability isn't a page. It's the whole plan.
          </h2>
          <p className="mt-4 text-primary-foreground/85">
            Every trip is carbon-offset through Rwanda's national reforestation program. We partner
            exclusively with eco-lodges and cooperatives, and 8% of every booking goes directly to
            Volcanoes NP conservation and community health projects around the park.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 md:px-6">
        <p className="mb-6 text-center text-xs font-semibold uppercase tracking-[0.25em] text-gold">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-center text-sm font-semibold text-muted-foreground">
          {PARTNERS.map((p) => (
            <div key={p} className="rounded-full border border-border px-4 py-2">
              {p}
            </div>
          ))}
        </div>
